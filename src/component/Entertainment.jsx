...
const Entertainment = () => {
    ...
    useEffect(() => {
        ...
        const fetchnews = () => {
            axios.get("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=30a733ed44764056a29aa1eeed027d69").then((res) => {
        ...
        <>
            ...
            <div className='container'>
                <div className='row mt-2' style={{ border: "red" }}>
                    <h1 style={{ textAlign: 'center', color: "red" }}>Top Headlines related to Entertainment</h1>
                    {
                        news.map((value) => {
                            return (
